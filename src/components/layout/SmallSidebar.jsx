...
const SmallSidebar = () => {
    ...
    return (
        <div className={`bg-white min-h-[100vh] ${width > 999 ? 'w-[85px]' : 'hidden'} text-white`}>
            <div className="border-b-[1px] border-dashed h-[73px] bg-white">
                <img className="w-[33px] pt-[20px] mx-auto py-2" src={logo} alt="logo" />
            </div>
            <div>
                <ul className="pt-3 px-1 flex flex-col items-center">
                    <li className="sidebar-link">
                        <Tooltip content="Dashboard">
                            <Link to="/" className="flex gap-3 items-center" title="Dashboard">
                                <svg
                    ...
                    <li className="sidebar-link" title="Categories">
                        <Tooltip content="Categories">
                            <Link to="/categories" className="flex gap-3 items-center">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 16 16"
                                    fill="currentColor"
                    ...
                    <li className="sidebar-link">
                        <Tooltip content="Model">
                            <Link to="/model" className="flex gap-3 items-center" title="Model">
                    ...
                    <li className="sidebar-link">
                        <Tooltip content="Form">
                            <Link to="/form" className="flex gap-3 items-center" title="Model">
                    ...
                    <li className="sidebar-link">
                        <Tooltip content="Table">
                            <Link to="/table" className="flex gap-3 items-center" title="Model">
