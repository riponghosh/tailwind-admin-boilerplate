    ...
    return (
        <>
            <div className="border-b-[1px] border-dashed h-[73px] bg-white">
                <img className="mx-auto w-[125px] py-2 pt-[24px] px-1" src={logo} alt="logo" />
            </div>
            <div>
                <ul className="pt-3 px-5">
                    ...
                    <li className="sidebar-link">
                        <Link to="/model" className="flex gap-3 items-center">
                    ...
                    <li className="sidebar-link">
                        <Link to="/form" className="flex gap-3 items-center">
                    ...
                    <li className="sidebar-link">
                        <Link to="/table" className="flex gap-3 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
                            ...
                            <span className="text-[15px]">Table</span>
                        </Link>
                    </li>
                </ul>
            </div>
